...
<div class="row row-cols-1 row-cols-md-3 g-4">
  ...
  <div class="col">
    <div class="card h-100">
      <img  class="arr" src=<?php echo $phones[$i]['img_url'];?> class="card-img-top" alt="...">
      <div class="card-body">
        <h5 class="card-title"><?php echo $phones[$i]['brand'];?></h5>
        <h2 class="card-text"><?php echo $phones[$i]['name'];?></h2>
        <?php
if($phones[$i]['rate'] == '1') {
  echo'<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="rgb(253, 177, 0)" class="bi bi-star-fill" viewBox="0 0 16 16">
    <path d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.282.95l-3.522 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z"/>
  </svg>';
  echo'<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="gray" class="bi bi-star-fill" viewBox="0 0 16 16">
    <path d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.282.95l-3.522 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z"/>
  </svg>';
  echo'<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="gray" class="bi bi-star-fill" viewBox="0 0 16 16">
    <path d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.282.95l-3.522 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z"/>
  ...
  echo'<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="gray" class="bi bi-star-fill" viewBox="0 0 16 16">
    ...
    ?>
      ...
      <div class="card-footer">
        <small><?php echo $phones[$i]['price'];?></small>
        <br><br>
        <button type="button" class="btn btn-lg btn-dark" >Buy now</button>
        <button type="button" class="btn btn-secondary btn-lg" ><i class='fa fa-shopping-cart'></i></button>
      </div>
    </div>
  </div>
  <?php } ?>
